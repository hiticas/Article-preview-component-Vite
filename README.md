...
## Live Demo
- **Solution URL:** https://article-preview-component-vite.netlify.app/

## Screenshot
![](preview.jpg)

A simple solution to the Frontend Mentor **Article preview component** challenge.
...
```bash
git clone https://github.com/hiticas/Article-preview-component-Vite.git
cd Article-preview-component-Vite
```
